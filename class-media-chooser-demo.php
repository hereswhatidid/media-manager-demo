...
class MediaChooserDemo {
	 ...
	 * @var      string
	 */
	protected $plugin_slug = 'media-chooser-demo';
	...
	public function enqueue_admin_scripts() {
		...
		if ( $screen->id == $this->plugin_screen_hook_suffix ) {
			...
			wp_localize_script( $this->plugin_slug . '-admin-script', 'baseUrl', site_url() );
		}
	...
	public function add_plugin_admin_menu() {
		...
		$this->plugin_screen_hook_suffix = add_plugins_page(
			__( 'Media Chooser Demo', $this->plugin_slug ),
			__( 'Media Chooser Demo', $this->plugin_slug ),
			'read',
			$this->plugin_slug,
